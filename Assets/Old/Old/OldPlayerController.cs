...
public class OldPlayerController : MonoBehaviour
{
        ...
        private List<OldBodyController> bodyRbs = new List<OldBodyController>();
        ...
        void Start()
        {
                ...
                bodyRbs.Add(newBody.GetComponent<OldBodyController>());
        ...
        void Update()
        {
                ...
                */
                ...
                mouseAngle = Mathf.Atan2(mousePosition.y - bodyRbs[bodyCurrent].transform.position.y,
                        mousePosition.x - bodyRbs[bodyCurrent].transform.position.x) * Mathf.Rad2Deg;
        ...
        private void SwingFunction()
        {
                ...
                if (weaponAngle > weaponBaseAngle) {
                        ...
                        if (weaponAngle > 110)
                        {
                                ...
                                weaponCoef *= -1;
                                // Spawn hitbox
                                GameObject hitbox = Instantiate(weaponHitboxObject, (Vector2) bodyRbs[bodyCurrent].transform.position + 
                                    new Vector2(Mathf.Cos(mouseAngle * Mathf.Deg2Rad), Mathf.Sin(mouseAngle * Mathf.Deg2Rad)),
                                    Quaternion.Euler(Vector3.forward * (mouseAngle)));
                                hitbox.GetComponent<OldWeaponHitboxController>().angle = mouseAngle;
                        }
                }
                else {
